package me.camm.productions.fortressguns.interact.item.Inventory;
...
import me.camm.productions.fortressguns.interact.item.Inventory.Abstract.*;
import org.bukkit.*;
...
public class BulkLoadingInventory extends TransactionReloadInventory {
    ...
    protected void onItemPickup(InventoryClickEvent event) {
        ...
        AmmoItem input = ItemUtils.isAmmoItem(residing);
        ...
        if (event.isRightClick()) {
            ...
            int exchange;
            if (input == null) {
                ItemStack ammoOut = ItemUtils.createAmmoItem(body.getLoadedAmmoType());

...
public abstract class RapidFire extends ArtilleryRideable {
    ...
    protected boolean instantiateParts(){
        ...
        pivot = StandHelper.createCore(getCurrentLocation(), BARREL_ITEM,aim,world, this);
        if (pivot == null)
            return false;
    ...
    protected boolean spawnBaseParts() {
        ...
        support = StandHelper.createVisiblePart(getCurrentLocation().clone().subtract(0,0.5,0),null,new EulerAngle(0,0,0), world,this);

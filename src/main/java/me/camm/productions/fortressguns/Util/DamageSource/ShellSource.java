...
public class ShellSource extends EntityDamageSourceIndirect {

    private final Entity owner;


    private ShellSource(String var0, Entity projectile, Entity owner) {
        super(var0, projectile, owner);
        this.owner = owner;
    }

    public static EntityDamageSource artilleryHit(EntityHuman entity, Entity projectile)
    {
        return new ShellSource("artillerydirect",projectile,entity).D();
    }
    ...
    public IChatBaseComponent getLocalizedDeathMessage(EntityLiving victim) {
        ...
        " now lives in a recycling plant thanks to " : " was turned to meat confetti by ";

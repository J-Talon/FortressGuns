...
// ! will change effects at some point

public class EffectFlare extends ExplosionEffect<Double> {
    @FunctionalInterface
    private interface EffectGroup {
        void perform (World world, double x, double y, double z, double percent);


        class TickSpark implements EffectFlare.EffectGroup {
            @Override
        ...
        class TickExpansion implements EffectFlare.EffectGroup {
        ...
        class TickSmoke implements EffectFlare.EffectGroup {
        ...
        class TickRecession implements EffectFlare.EffectGroup {
    ...
    private static final EffectFlare.EffectGroup[] tickParams;

    static {
        tickParams = new EffectFlare.EffectGroup[]{
                new EffectFlare.EffectGroup.TickSpark(),
                new EffectFlare.EffectGroup.TickExpansion(),
                new EffectFlare.EffectGroup.TickSmoke(),
                new EffectFlare.EffectGroup.TickRecession()
        };
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (tick < tickParams.length) {
                    EffectFlare.EffectGroup group = tickParams[tick];
